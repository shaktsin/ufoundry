...
if TYPE_CHECKING:
    from ufoundry.config.schema import SkillRuntimeOverride, SkillsConfig
    from ufoundry.skills.registry import Skill

logger = logging.getLogger("ufoundry.skills.runtime")
