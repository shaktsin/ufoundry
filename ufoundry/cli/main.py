...
def main() -> None:
    ...
    if args.command == "onboard":
        from ufoundry.cli.onboard import run_wizard
        ...
        from ufoundry.cli.doctor import run_diagnostics

        run_diagnostics(config_path=args.config)

    elif args.command == "connections":
        from ufoundry.cli.connections import show_status

        show_status(config_path=args.config, live=args.live)

    elif args.command == "start":
        from ufoundry.cli.daemon import start_daemon

        start_daemon(args.config, args.log_level)

    elif args.command == "stop":
        from ufoundry.cli.daemon import stop_daemon

        stop_daemon(args.config)

    elif args.command == "status":
        from ufoundry.cli.daemon import show_daemon_status

        show_daemon_status(args.config)

    elif args.command == "reload":
        from ufoundry.cli.daemon import reload_daemon

        reload_daemon(args.config)

    elif args.command == "orchestrate":
        from ufoundry.orchestrator import main as orchestrate_main
        ...
        if args.channel == "telegram":
            ...
            from ufoundry.connectors.telegram_bot_connector import main as telegram_main

            telegram_main()
        elif args.channel == "telegram-user":
            from ufoundry.connectors.telegram_user_connector import main as telegram_user_main
        ...
        from ufoundry.cli.skills import handle_skills

        handle_skills(args)

    elif args.command == "tasks":
        from ufoundry.cli.tasks import handle_tasks

        handle_tasks(args)

    elif args.command == "panel":
        from ufoundry.cli.panel import run_panel
        ...
        from ufoundry.cli.google import cmd_setup, cmd_login, cmd_status, cmd_logout
        ...
        from ufoundry.cli.control_panel_setup import run_setup
