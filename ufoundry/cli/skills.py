...
def install_skill(path: str, *, config_path: str | None) -> None:
    ...
    from ufoundry.skills.registry import lint_skill_dir
    ...
    install_root = Path.home() / ".ufoundry" / "skills"
...
def remove_skill(name: str, *, config_path: str | None = None) -> None:
    ...
    target = (Path.home() / ".ufoundry" / "skills" / name).resolve()
    root = (Path.home() / ".ufoundry" / "skills").resolve()
