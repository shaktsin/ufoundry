...
from ufoundry.config import load_config, save_config

console = Console()
logger = logging.getLogger("ufoundry.cli.control_panel_setup")
...
async def setup_telegram_control_panel(config_path: Optional[str] = None) -> bool:
    ...
    if not connector_exists:
        from ufoundry.config.schema import ConnectorConfig
    ...
    console.print(Panel.fit(
        ...
        f"  1. Start UFoundry: [bold]make start[/bold]\n"
