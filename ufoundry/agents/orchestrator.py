...
from ufoundry.llm.base import LLMClient, LLMResponse, ToolCall
from ufoundry.tools.registry import Attachment

from .agent import SpawnedAgent, _assistant_message

logger = logging.getLogger("ufoundry.agents.orchestrator")
...
class DynamicOrchestrator:
    ...
    async def run(self, task: str, history: Optional[List[Dict[str, Any]]] = None) -> str:
        ...
        from ufoundry.tools.workspace import workspace_summary
    ...
    async def _spawn_agent(self, args: Dict[str, Any]) -> str:
        from ufoundry.tools.workspace import resolve_workspace, set_active_workspace
