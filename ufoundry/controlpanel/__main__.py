"""Run the control panel as a module: python -m ufoundry.controlpanel"""
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="ufoundry.controlpanel")
    ...
    from ufoundry.controlpanel.server import run_panel
